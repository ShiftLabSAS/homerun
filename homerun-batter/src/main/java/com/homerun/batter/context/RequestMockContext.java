package com.homerun.batter.context;
 ...
 * HTTP request. Injected into the {@link com.homerun.batter.support.MockClientSupport}
 * base class via a Spring scoped proxy, so the singleton router never caches state
 * between requests.
 *
 * <p>Populated by {@link com.homerun.batter.filter.MockHeaderFilter} early in the
