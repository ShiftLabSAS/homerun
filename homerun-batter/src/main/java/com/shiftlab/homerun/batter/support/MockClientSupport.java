package com.shiftlab.homerun.batter.support;
...
import com.shiftlab.homerun.batter.exception.MockConfigurationException;
import com.shiftlab.homerun.batter.exception.MockDeserializationException;
import com.shiftlab.homerun.batter.exception.MockRequestMismatchException;
 ...
 *   <li>Dispatch based on {@link com.shiftlab.homerun.common.model.MockBehaviorType}:
...
public abstract class MockClientSupport {
     ...
     *
     * <p>Used by {@link com.shiftlab.homerun.batter.HomeRunBatter} to auto-build its internal
     ...
     * {@link com.shiftlab.homerun.batter.async.MockContextTaskDecorator}.
     */
