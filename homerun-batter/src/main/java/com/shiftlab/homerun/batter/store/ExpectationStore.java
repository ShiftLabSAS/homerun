...
public interface ExpectationStore {
     ...
     *
     * @throws com.shiftlab.homerun.batter.exception.MockExpectationNotFoundException if no
     *         matching expectation exists
     * @throws com.shiftlab.homerun.batter.exception.MockExpectationExpiredException if the
