 ...
 * HTTP request. Injected into the {@link ar.shiftlab.homerun.batter.support.MockClientSupport}
 * base class via a Spring scoped proxy, so the singleton router never caches state
 * between requests.
 *
 * <p>Populated by {@link ar.shiftlab.homerun.batter.filter.MockHeaderFilter} early in the
