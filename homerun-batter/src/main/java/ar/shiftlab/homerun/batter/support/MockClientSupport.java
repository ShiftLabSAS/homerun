package ar.shiftlab.homerun.batter.support;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import ar.shiftlab.homerun.batter.context.RequestMockContext;
import ar.shiftlab.homerun.batter.context.RequestMockContextHolder;
import ar.shiftlab.homerun.batter.exception.MockConfigurationException;
import ar.shiftlab.homerun.batter.exception.MockDeserializationException;
import ar.shiftlab.homerun.batter.exception.MockRequestMismatchException;
 ...
 *   <li>Dispatch based on {@link ar.shiftlab.homerun.common.model.MockBehaviorType}:
...
public abstract class MockClientSupport {
     ...
     *
     * <p>Used by {@link ar.shiftlab.homerun.batter.HomeRunBatter} to auto-build its internal
     ...
     * {@link ar.shiftlab.homerun.batter.async.MockContextTaskDecorator}.
     */
